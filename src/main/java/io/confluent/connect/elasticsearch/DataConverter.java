...
public class DataConverter {
  ...
  public static ESRequest convertRecord(
    ...
    if (topicConfigs.containsKey(topic)) {
      log.info("Topic found in topicConfigs");
      ...
      log.info("Topic not found in topicConfigs");
      index = topic;
      topicIgnoreKey = ignoreKey;
      topicIgnoreSchema = ignoreSchema;
    }
    log.info("Config values: index {} / ignoreKey {} / ignoreSchema {}", index, topicIgnoreKey, topicIgnoreSchema);
